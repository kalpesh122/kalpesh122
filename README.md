...
- **LLM agents in production** — provider-abstracted layer (Anthropic / OpenRouter / OpenAI) running a tool-use loop over 25 tools, with SSE token streaming and confirmation gating on destructive actions.
